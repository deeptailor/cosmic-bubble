...
/***/ function(module, exports, __webpack_require__) {
	...
	class Game {
	  ...
	  addBubbles(num, vel=0.1) {
	    ...
	    for (let i = 0; i < num; i++) {
	      this.add(new Bubbles({ game: this, vel: Util.randomVec(vel), colorNum: this.level}));
	    }
	  }
	  ...
	  allObjects() {
	    if(this.bubbles.length < 2){
	      this.addBubbles(70, (this.level*0.1));
...
/***/ function(module, exports, __webpack_require__) {
	...
	const randomColor = (num = 0) => {
	  ...
	  const colors2 = ['#451970', '#191970', '#3252b2', '#4876ff', '#ebeed9'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	class Ship extends MovingObject {
	  constructor(options){
	    options.color = options.color || '#ffc125';
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Ship = __webpack_require__(5);
	const key = __webpack_require__(9);
	  ...
	  animate(time) {
	    ...
	    if (allObjects.length <= 1){
	      if(allObjects[0] instanceof Ship){
	        ...
	        document.cookie = `score=${this.game.score}`
